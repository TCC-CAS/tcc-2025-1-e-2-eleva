 -- =============================================
  ...
  (5, 'PREMIUM',  'MENSAL', 199.90, 'APROVADO', DATEADD(DAY, -8,  SYSDATETIME()), '1004', 'MASTERCARD', 'JARDINS PREMIUM LTDA'),
  (6, 'PREMIUM',  'MENSAL', 199.90, 'APROVADO', DATEADD(DAY, -7,  SYSDATETIME()), '3009', 'VISA', 'ESTACIONAMENTO FARIA LIMA LTDA');
  GO
